...
# Petrové projekty (10 celkem)
1. 4rap.cz — Czech Rap Knowledge Platform. 1699 entit, 9281 vztahů, Next.js + MDX, D3-force grafy, SEO, Schema.org. https://4rap.cz
2. 4Rap Studio — 4Bars (lyric editor s AI) + 4Flow (beat visualizer)
3. AI CharStudio — lokální dashboard pro generativní AI workflows, ComfyUI + LLM
4. Ollama Web Builder — AI editor pro real-time generování kódu, Ollama API
5. StyleMorph — AI redesign HTML stránek, Gemini/Ollama. github.com/Peter-Pix/StyleMorph
6. Scrollo.cz — webové nástroje zdarma bez reklam, PWA. peter-pix.github.io/scrollo.cz
7. AutoBlog Publisher — automatizace SEO článků, LLM + CMS. github.com/Peter-Pix/AutoBlog-Publisher
8. ComfyUI Environment Manager — správa Python prostředí pro AI, CUDA 12.8, PyTorch
9. Local AI Assistants — Ollama, agentní architektury, MCP, knowledge graphy
10. AI Media & Virtual Characters — personalizované virtuální postavy
